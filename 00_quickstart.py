...
# keywords = kw_model.extract_keywords(documents) # directly extract keywords
# keywords = kw_model.extract_keywords(documents, keyphrase_ngram_range=(1, 2), stop_words=None)  # extract keyphrase according to your need

keywords = kw_model.extract_keywords(
    documents, keyphrase_ngram_range=(1, 2), stop_words=None, highlight=True
)
